...
namespace MotoBest.Data.Migrations
{
    ...
    [Migration("20220516184247_AddExtraTypeAsModel2")]
    partial class AddExtraTypeAsModel2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvertExtra", b =>
                {
                    b.Property<string>("AdvertsId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("ExtrasId")
                        .HasColumnType("int");

                    b.HasKey("AdvertsId", "ExtrasId");

                    b.HasIndex("ExtrasId");

                    b.ToTable("AdvertExtra");
                });
            ...
            modelBuilder.Entity("AdvertExtra", b =>
                {
                    b.HasOne("MotoBest.Data.Models.Advert", null)
                        .WithMany()
                        .HasForeignKey("AdvertsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MotoBest.Data.Models.Extra", null)
                        .WithMany()
