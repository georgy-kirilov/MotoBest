...
public static class DesktopAutoBgScrapedAdverts
{
    ...
    public static readonly ScrapedAdvert Test_009 = new()
    {
        ...
        "движение, система за контрол на налягането в гумите, сензор за дъжд, халогени, LED стоп светлини, автоматични дълги светлини, двоен шибидах.  Трейд Ин доставя за Вас всички марки и модели автомобили, произведени за американския пазар. Разполагаме със собствена сервизна база за поддръжка на автомобилите, закупени от нас, лизинг и обратно изкупуване.",
        Price = 0,
        CurrencyUnit = null,
        BodyStyle = "Джип",
        Engine = "benzinov",
